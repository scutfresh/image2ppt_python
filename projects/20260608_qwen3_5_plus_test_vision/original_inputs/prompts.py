...
You MUST IGNORE the absolute dimensions ({width}x{height}) when drawing bounding boxes. 
ALL `bbox` fields MUST be normalized to a 0-1000 scale (where 0 is top/left, 1000 is bottom/right). 
Example: A box covering the entire image is {{"x": 0, "y": 0, "w": 1000, "h": 1000}}. DO NOT use values > 1000.
